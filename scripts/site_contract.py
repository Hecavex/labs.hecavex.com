...
ROUTES = (
    ...
    Route("changes/index.html", "/changes/", "changes", "link", utility_href="/changes/feed.json", utility_text="JSON feed", sitemap_lastmod="2026-09-10"),
    Route("methodology/index.html", "/methodology/", "methodology", "link", utility_href="https://github.com/Hecavex/labs.hecavex.com", utility_text="Source", sitemap_lastmod="2026-09-10"),
